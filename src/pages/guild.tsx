    ...
    <div>
      ...
      <section>
        <HeaderSection
          ...
          headerText="You can help us"
          headerTextHighlight="bring you another concert."
          headerTextHighlightColor="from-secondary-light to-primary-light"
        />
        <FeatureSection
          headerText="A 10 year legacy of"
          headerTextHighlight="bringing Chinese Music to the World."
          videoSrc="https://res.cloudinary.com/df23ubjbb/video/upload/v1640791445/General%20Media/TheGuildVid.mp4"
        >
          In 2012, our founder took what little was left from his disability
          check to pay for someone&apos;s therapy. Alone, he was able to pay for
          one therapy session each month.
          <span className="text-primary">
            {" "}
            As a guild member, you helps us cover thousands of therapy sessions
            for people in need.
          </span>
        </FeatureSection>
        <FeatureSection
        ...
        >
          We are a community of people who are passionate about mental health,
          united in our support for healing others.
          <span className="text-primary">
            {" "}
            Your guild membership awards you with a unique title in our Discord
            community, which highlights the healing you make possible.
          </span>
        </FeatureSection>
      </section>
