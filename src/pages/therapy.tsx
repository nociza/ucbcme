    ...
    <div>
      ...
      <section>
        ...
        <SectionHighlight>
          <SectionGrid>
            <div className="space-y-2">
              ...
              <p>
                The intake form is for you to share more about how you&apos;re
                feeling and what you&apos;d like to work on with RAD. Everything
                shared is 100% private.
              </p>
            </div>
          </SectionGrid>
        </SectionHighlight>
        <FeatureSection
          ...
          reverse
        >
          Connect directly with our social workers. We&apos;ll explore your
          intake and discuss finding you the perfect therapist.
        </FeatureSection>
      </section>
